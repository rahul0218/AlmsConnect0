...
if(isset($_REQUEST['ds'])){
	...
	$_SESSION['gadd']=$_POST['gadd'];
	$_SESSION['gdstatus']='Pending';
	$_SESSION['gdcstatus']='Waiting';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <script>
                    function validate()
                    {
                      var gdtype=document.getElementsByName("gdtype[]");
                      var itemchecked=0;
            ...
            <form class="needs-validation" action="gdinsert.php" method="post" onSubmit="return validate()" novalidate>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                                  ...
                                  if(in_array($item,$oditem)){
                                    ...
                                    <div class="col">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="gdtype[]" value="<?php echo $item;?>">
                       ...
                       <div class="input-group form-group">
                            ...
                            <input type="text" maxlength="10" minlength="10" name="gphno" class="form-control" id="phone" placeholder="Phone" pattern="^\d{10}$" required>
                            <div class="valid-feedback">Looks good!</div>
                        </div>
                      <!--ID Card-->
                      <div class="form-group">
                            <select class="custom-select" id = "guel" name = "guel" required>
                        ...
                        <div class="input-group form-group">
                            ...
                            <input type="text" class="form-control" id="gidno" placeholder="ID Number" name="gidno"  minlength="10" maxlength="12" required>
                            <div class="valid-feedback">Looks good!</div>
                        </div> 

                    <div class="form-group">
                        <input type="submit" value="Donate" name="sub" class="btn-block login_btn btn btn-primary">
                    </div>
                </div>
            <div>
            </form>
