...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <!--script for npwd & ncpwd end-->

            <form class="needs-validation" action="uchngpwd_react.php" method="post" onsubmit="return validatePassword()" novalidate>
            <?php
                if($n['upwd']!="")
                {
                ?>
            ...
            <?php
                    ...
                    {
                    ?> 
                     <h1 class="text-center">Add Local Password</h1>
                     <?php
                    }
                    ?>
            <hr>
            <div class="row">
                ...
                ?>
                  ...
                  <div class="input-group form-group">
                          ...
                          <input type="password" class="form-control" name="uopwd" id="uopwd" placeholder="Enter Old Password" maxlength="30" pattern="(?=.*[a-z])(?=.*[A-Z]).{8,}" required data-toggle="password">
                   ...
                   <?php
                    ...
                    ?>   
                       ...
                       <div class="input-group form-group">
                          ...
                          <input type="password" class="form-control" name="unpwd" id="unpwd" placeholder="Enter New Password" maxlength="30" pattern="(?=.*[a-z])(?=.*[A-Z]).{8,}" data-toggle="password" required>
                          <div class="input-group-append">
                          <span class="input-group-text"><i class="fa fa-eye"></i></span>
                          </div>
                          <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="input-group form-group">
                          ...
                          <input type="password" class="form-control" name="uncpwd" id="uncpwd" maxlength="30"  pattern="(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="Reenter New Password" data-toggle="password" required>
                          <div class="input-group-append">
                          <span class="input-group-text"><i class="fa fa-eye"></i></span>
                          </div>
                          <div class="valid-feedback">Looks good!</div>
                    ...
                    <?php
                      ...
                      {
                      ?>
                      <input type="submit" name="submit" value="Change" class="btn-block login_btn btn btn-primary">
                    <?php
                      }
                      else{
                    ?>
                    <input type="submit" name="submit" value="Add" class="btn-block login_btn btn btn-primary">
                    </div>
                    <?php
                      }
                    ?>
