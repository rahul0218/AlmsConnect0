          ...
          <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <ul class="navbar-nav mr-auto navbar-right">
              ...
              <div class="row" align="right">
                ...
                <li class="nav-item">
                  <img src="https://pbs.twimg.com/profile_images/1058648905955586048/J589bj3T_400x400.jpg" alt="team member" class="img-responsive" style="border-radius: 50%;" width="50" height="50">
                </li>
                <li>&nbsp&nbsp</li>
                <li class="nav-item">
                  
                    <span class="input-group-text" style="border-radius:50px; margin-top:7px;"><i class="fa fa-power-off"></i></span>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <!--Match pwd & cpwd Start-->
            <script type="text/javascript">
                var password = document.getElementById("unpwd")
                , confirm_password = document.getElementById("uncpwd");
            ...
            <!---->
            <form class="needs-validation" action ="ufrgtpwd_react.php" method ="POST" onsubmit="validatePassword()" novalidate>
            <h1 class="text-center">User Update Password</h1>
            <hr>
            <div class="row">
                <div class="col-md-12">
                   <!--Password-->
                   <div class="input-group form-group">
                          ...
                          <input type="password" class="form-control" placeholder="New Password" data-toggle="password" name="unpwd" id="unpwd" maxlength="30" pattern="(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                      ...
                      <div class="input-group form-group">
                          ...
                          <input type="password" class="form-control" placeholder="New Confirm Password" data-toggle="password"  name="uncpwd" id="uncpwd"  maxlength="30" pattern="(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                          <div class="input-group-append">
                          <span class="input-group-text"><i class="fa fa-eye"></i></span>
                          </div>
                          <div class="valid-feedback">Looks good!</div>
           ...
           <!---->
                    <div class="form-group">
                        <input type="submit" name="change"  value="Update" class="btn-block login_btn btn btn-primary">
                    </div>
                </div>
            <div>
            </form>
...
.ft{
  background-image:url(../sectionimage/fb.jpg);
  background-size:cover; 
}
</style>
  </section>
